Copy (SELECT user_id, 
	...
	GROUP BY user_id) 
To '/Users/nancy/Documents/Git Repo/Google Case Studies/bellabeat-analysis/psql-queries/csv-export/avg_activity_per_min.csv' 
...
Copy (SELECT user_id, 
	...
	FROM activity_per_minute
	GROUP BY user_id) 
To '/Users/nancy/Documents/Git Repo/Google Case Studies/bellabeat-analysis/psql-queries/csv-export/max_activity_per_min.csv' 
With CSV DELIMITER ',' HEADER;
...
Copy (SELECT user_id, 
	...
	GROUP BY user_id) 
To '/Users/nancy/Documents/Git Repo/Google Case Studies/bellabeat-analysis/psql-queries/csv-export/avg_hourly_activity.csv' 
With CSV DELIMITER ',' HEADER;
...
Copy (SELECT user_id, 
	...
	FROM hourly_activity
	GROUP BY user_id) 
To '/Users/nancy/Documents/Git Repo/Google Case Studies/bellabeat-analysis/psql-queries/csv-export/max_hourly_activity.csv' 
With CSV DELIMITER ',' HEADER;
...
Copy (SELECT user_id, 
	...
	FROM daily_activity
	GROUP BY user_id) 
To '/Users/nancy/Documents/Git Repo/Google Case Studies/bellabeat-analysis/psql-queries/csv-export/avg_daily_activity.csv' 
With CSV DELIMITER ',' HEADER;
...
Copy (SELECT user_id, 
	...
	FROM daily_activity
	GROUP BY user_id) 
To '/Users/nancy/Documents/Git Repo/Google Case Studies/bellabeat-analysis/psql-queries/csv-export/median_daily_activity.csv' 
With CSV DELIMITER ',' HEADER;
...
Copy (SELECT user_id, 
	...
	FROM daily_activity
	GROUP BY user_id) 
To '/Users/nancy/Documents/Git Repo/Google Case Studies/bellabeat-analysis/psql-queries/csv-export/min_daily_activity.csv' 
With CSV DELIMITER ',' HEADER;
...
Copy (SELECT user_id, 
	...
	FROM daily_activity
	GROUP BY user_id) 
To '/Users/nancy/Documents/Git Repo/Google Case Studies/bellabeat-analysis/psql-queries/csv-export/max_daily_activity.csv' 
With CSV DELIMITER ',' HEADER;
...
Copy (SELECT user_id, 
	...
	GROUP BY user_id) 
To '/Users/nancy/Documents/Git Repo/Google Case Studies/bellabeat-analysis/psql-queries/csv-export/avg_sleep_activity.csv' 
With CSV DELIMITER ',' HEADER;
...
Copy (SELECT user_id, 
	...
	FROM daily_sleep_data
	GROUP BY user_id) 
To '/Users/nancy/Documents/Git Repo/Google Case Studies/bellabeat-analysis/psql-queries/csv-export/median_sleep_activity.csv' 
With CSV DELIMITER ',' HEADER;
...
Copy (SELECT user_id, 
	...
	FROM daily_sleep_data
	GROUP BY user_id) 
To '/Users/nancy/Documents/Git Repo/Google Case Studies/bellabeat-analysis/psql-queries/csv-export/min_sleep_activity.csv' 
With CSV DELIMITER ',' HEADER;
...
Copy (SELECT user_id, 
	...
	FROM daily_sleep_data
	GROUP BY user_id) 
To '/Users/nancy/Documents/Git Repo/Google Case Studies/bellabeat-analysis/psql-queries/csv-export/max_sleep_activity.csv' 
With CSV DELIMITER ',' HEADER;
...
Copy (SELECT user_id, 
	...
	FROM weight_log
	GROUP BY user_id) 
To '/Users/nancy/Documents/Git Repo/Google Case Studies/bellabeat-analysis/psql-queries/csv-export/avg_weight_data.csv' 
With CSV DELIMITER ',' HEADER;
...
Copy (SELECT user_id, 
	...
	FROM weight_log
	GROUP BY user_id) 
To '/Users/nancy/Documents/Git Repo/Google Case Studies/bellabeat-analysis/psql-queries/csv-export/min_weight_data.csv' 
With CSV DELIMITER ',' HEADER;
...
Copy (SELECT user_id, 
	...
	FROM weight_log
	GROUP BY user_id) 
To '/Users/nancy/Documents/Git Repo/Google Case Studies/bellabeat-analysis/psql-queries/csv-export/max_weight_data.csv' 
With CSV DELIMITER ',' HEADER;
...
Copy (SELECT user_id, 
	...
	FROM heart_rate
	GROUP BY user_id) 
To '/Users/nancy/Documents/Git Repo/Google Case Studies/bellabeat-analysis/psql-queries/csv-export/avg_heart_rate.csv' 
With CSV DELIMITER ',' HEADER;
...
Copy (SELECT user_id, 
	...
	FROM heart_rate
	GROUP BY user_id) 
To '/Users/nancy/Documents/Git Repo/Google Case Studies/bellabeat-analysis/psql-queries/csv-export/median_heart_rate.csv' 
With CSV DELIMITER ',' HEADER;
...
Copy (SELECT user_id, 
	...
	FROM heart_rate
	GROUP BY user_id) 
To '/Users/nancy/Documents/Git Repo/Google Case Studies/bellabeat-analysis/psql-queries/csv-export/min_heart_rate.csv' 
With CSV DELIMITER ',' HEADER;
...
Copy (SELECT user_id, 
	...
	FROM heart_rate
	GROUP BY user_id) 
To '/Users/nancy/Documents/Git Repo/Google Case Studies/bellabeat-analysis/psql-queries/csv-export/max_heart_rate.csv' 
With CSV DELIMITER ',' HEADER;
...
To '/Users/nancy/Documents/Git Repo/Google Case Studies/bellabeat-analysis/psql-queries/csv-export/avg_daily_activity_by_dow.csv' 
With CSV DELIMITER ',' HEADER;
...
Copy (SELECT EXTRACT(isodow from sleep_date) AS day_of_week,
	...
	GROUP BY day_of_week
	ORDER BY day_of_week) 
To '/Users/nancy/Documents/Git Repo/Google Case Studies/bellabeat-analysis/psql-queries/csv-export/avg_daily_sleep_activity_by_dow.csv' 
With CSV DELIMITER ',' HEADER;
